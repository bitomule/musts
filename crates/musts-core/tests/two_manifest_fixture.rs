...
use musts_core::manifest::{check_id, discover, parse, scope_path_for, ROOT_SCOPE};
use musts_core::snapshot::{compute_scope_hash, hash_bytes, hash_file, ScopeInput};
use musts_core::state::open;
